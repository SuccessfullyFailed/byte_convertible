pub trait ByteConvertible:Clone {
...
impl<T, const LENGTH:usize> ByteConvertible for [T; LENGTH] where T:ByteConvertible {
...
impl<T> ByteConvertible for Vec<T> where T:ByteConvertible {
